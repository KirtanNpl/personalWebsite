            ...
            <div className="flex flex-col items-start gap-4">
              <div className="overflow-hidden">
                <div className="dark:text-white text-animation">
                  With over 3 years of experience as a developer, I
                  specialize in crafting user-friendly web
                  applications. I excel in creating intuitive interfaces and
                  enjoy working in collaborative, agile environments with knowledge in frontend as well as in backend.
                </div>
              </div>
              ...
              <div className="flex gap-1 flex-col items-start">
                <div className="text-accentColor">Nagarjuna College of IT</div>
                <div className="overflow-hidden">
                  <div className="dark:text-white text-animation">
                    Joined Bachelor Level Program(BSc. CSIT) to embark on an enriching educational
                    journey designed to build a solid foundation.
                  </div>
                </div>
              </div>
            </div>
